...
const CommunityPage = () => {
  ...
  const applyFilter = async () => {
    ...
    const response = await fetch(`https://nutri-delivery-git-modificar-conexiondb-kevinb00s-projects.vercel.app/backend/actions/read/getAllPosts.php?${query}`);
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      const response = await fetch("https://nutri-delivery-git-modificar-conexiondb-kevinb00s-projects.vercel.app/backend/actions/read/getAllPosts.php");
      const data = await response.json();
      setPosts(data);
    };
    fetchPosts();
