...
const Perfil = () => {
  ...
  useEffect(() => {
    ...
    const fetchUserPosts = async () => {
      const response = await fetch(
        `https://nutri-delivery-git-modificar-conexiondb-kevinb00s-projects.vercel.app/backend/actions/read/getUserPosts.php?id_usuario=${id_usuario}`
      );
      if (response.ok) {
    ...
    const fetchUserFavorites = async () => {
      const response = await fetch(
        `https://nutri-delivery-git-modificar-conexiondb-kevinb00s-projects.vercel.app/backend/actions/read/getUserFavoritos.php?id_usuario=${id_usuario}`
      );
      if (response.ok) {
        const data = await response.json();
        setFavoritos(data);
    ...
    const fetchUserComments = async () => {
      const response = await fetch(
        `https://nutri-delivery-git-modificar-conexiondb-kevinb00s-projects.vercel.app/backend/actions/read/getUserComentarios.php?id_usuario=${id_usuario}`
      );
      if (response.ok) {
        const data = await response.json();
        setComentarios(data);
  ...
  const handleSubmitModify = (event) => {
    ...
    if (validateForm()) {
      ...
      fetch(
        `https://nutri-delivery-git-modificar-conexiondb-kevinb00s-projects.vercel.app/backend/actions/update/updateUsuario.php`,
        {
          method: "POST",
          headers: {
